...
pc_overruns_states<-data.frame(State_new = c("Australian Capital Territory","New South Wales","Northern Territory","Queensland",
                               ...
                               sample_size = c(SS_coall_table_8[1], SS_coall_table_8[2], SS_coall_table_8[3], SS_coall_table_8[4], 
                                               SS_coall_table_8[5], SS_coall_table_8[6], SS_coall_table_8[7], SS_coall_table_8[8], SS_coall_table_8[9]))
pc_overruns_states<-cbind(pc_overruns_states, str(t(SS_coall_table_8))

sample_size <- data.frame(States = t(SS_coall_table_8))                          
