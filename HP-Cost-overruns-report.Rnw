...
final_status_by_GR <- 
  ...
  mutate(final_pipeline_status = last(Status_ordered, order_by = Record_date),
         Final_status_historical =  if_else(is.na(Final_status_historical) & final_pipeline_status %in% c("Possible", "Under considertaion", "Committed"), 
...
cancellation_by_project_stage <-
  ...
  mutate(n_first_status_possible = length(which(first_pipeline_status == "Possible")),
         n_first_status_under_consideration = length(which(first_pipeline_status == "Under consideration")),
         ...
         n_deleted_as_possible = length(which(final_pipeline_status == "Possible" & Final_status_historical == "Deleted")),
         n_deleted_as_under_consideration = length(which(final_pipeline_status == "Under consideration" & Final_status_historical == "Deleted")),
         ...
         n_projects_w_possible = n_first_status_possible, 
         n_projects_w_under_consideration = n_projects_w_possible + n_first_status_under_consideration - n_deleted_as_possible,
         n_projects_w_possible_or_under_consideration = n_projects_w_possible + n_first_status_under_consideration,
         n_projects_w_committted = n_projects_w_under_consideration + n_first_status_committted - n_deleted_as_under_consideration,
         n_projects_w_under_construction = n_projects_w_committted + n_first_status_under_construction - n_deleted_as_committted,
         possible_cancellation_rate = n_deleted_as_possible/n_projects_w_possible, 
         under_consideration_cancellation_rate = n_deleted_as_under_consideration/n_projects_w_under_consideration,
         possible_or_under_consideration_cancellation_rate = (n_deleted_as_possible+n_deleted_as_under_consideration)/n_projects_w_possible_or_under_consideration,
  ...
  select(possible_cancellation_rate, under_consideration_cancellation_rate, possible_or_under_consideration_cancellation_rate, committed_cancellation_rate, under_construction_cancellation_rate, overrall_cancellation_rate) %>%
  unique
