...
cancellation_by_project_stage <-
  ...
  mutate(n_first_status_possible_or_under_consideration = length(which(first_pipeline_status == "Possible or under consideration")),
         ...
         n_projects_w_committted = n_first_status_possible_or_under_consideration + n_first_status_committted - n_first_status_possible_or_under_consideration,
...
<<WORK IN PROGRESS cancellation_and_cost_overruns>>=
