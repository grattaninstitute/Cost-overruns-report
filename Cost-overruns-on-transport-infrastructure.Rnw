...
The initial funding commitments (\$136m, \$337m, \$370m) were for a road 20 per cent shorter.\footcite[][40]{GovWA2005MainRoads} By the time the road was contracted in 2006, an enhancement of a section of the existing Kwinana Highway between Baldavis and Karnup was included.\footcites[][87]{GHDPerthtoBunbury,AusGov2012InfrastructurePlanningDelivery}
...
\begin{figure}[H]
 ...
 \includegraphics[page=2]{atlas/CaseStudies.pdf}\label{fig:CS_Forrest}
\end{figure}
