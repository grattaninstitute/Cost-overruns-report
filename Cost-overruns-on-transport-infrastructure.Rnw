...
Westconnex & NSW & \possibleTextDollar16\,800\dz & n/a & 6\%\tablefootnote{``The Infrastructure Australia assessment makes reference to a six per cent difference between the P50 and P90 on the Stage 2'' (SGS, February 2016, page 23)}\tabularnewline[1.245ex]
...
\footnote{Love (2014), p500; Hinze et al, pp87-88.} While this may occur on some projects, we do not find significant evidence of low initial bids leading to later overruns.
...
1. \url{http://anthonyalbanese.com.au/category/ministerial-media-releases/page/26}
\end{smallbox}
...
{Subtitle}
\includegraphics{Example-image}\label{}
