...
Ultimately all cost estimates use some combination of four tools: expected value, sensitivity analysis, probability pricing, and reference class forecasting (see \Vref{box:REFCLASSFORECAST}).
