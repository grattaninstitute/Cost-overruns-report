...
\begin{figure}
\captionwithunits{The quality of risk management guidance varies\label{quality-of-risk-management-guidance-chevrons}}
{Guidance quality by jurisdiction and topic ranked as sufficient, incomplete and poor by green, orange and red, respectively.}

\noteswithsource{}
{See section [LAST SECTION OF RISK APPENDIX] for the list of reviewed guidelines, Grattan analysis}
\end{figure}
...
Consistent use of risk matrices or like tools to identify and mitigate avoidable risks on construction projects is extremely important. This is because active mitigation of cost risks can reduce the frequency with which large cost overruns occur, as illustrated in figure XX.

\begin{figure}
\captionwithunits{Some avoidable risks can be mitigated \label{Some-avoidable-risks-can-be-mitigated}}
...
Providing detailed guidance on how project costs should be estimated for each level of project maturity allows governments to increase their confidence that projects will come in on budget, as illustrated in figure \ref{Reduce-estimation-error-diagram}. Such increased cost certainty should be pursued insofar as the benefits outweigh the costs.

\begin{figure}
\captionwithunits{More projects finish on budget when estimation error has been minimised \label{Reduce-estimation-error-diagram}}
{Stylized representation of the probability of cost overruns of each size, per cent}
...
As it stands, risk measurement guidance is very inconsistent between each state and the Commonwealth. Table \ref{consistency-table} shows that the expected value approach to estimating risks' costs is the only approach that is recommended consistently across all jurisdictions.
...
\textbf{Figure XX: The recommended size of contingency funds varies substantially across guidelines\\
...
\emph{Notes: The contingency ranges cited in the National Guidelines for Transport System Management refer specifically to road projects specifically, and are anticipated to be too conservative for projects which are one-off in nature.\\
Sources:}
...
\protect\hypertarget{ux5fRef328496177}{}Figure : Cost overrun by project stage in Investment Monitor and Grattan datasets

\includegraphics{media/image6.emf}

Notes: Cost overruns are defined as the percentage change over the period of interest as a proportion of the project's initial cost estimate.\\
Source: Deloitte-Access Investment Monitor; Grattan dataset; Grattan analysis.
...
\protect\hypertarget{ux5fRef462914253}{}

\textbf{FigureXX: Cost overruns are likely to be higher than reported\\
}Average cost overrun rates as a proportion of initial costs, by project stage

\includegraphics{media/image7.png}

Notes: Australian transport projects completed between 2001 and 2015\\
Source: Deloitte Investment Monitor, Grattan analysis.
...
Where\\
\(CO_{t}\) and \(CO_{t + 1}\) refer to cost overruns incurred over the consecutive project stages\\
...
Box XX in chapter XX features a stylized representation of the distribution of cost overruns. This stylized distribution, presented as figure XX below, is also employed in figures XX, XX and XX of appendix 1.
...
Figure 1 in chapter 5.2.2 presents the financial advantages of managing cost risk at the portfolio level relative to the project level.
...
\begin{quote}
\textbf{Raw copy of this graph:}

\textbf{Figure XX: The quality of risk management guidance varies\\
}Guidance quality by jurisdiction and topic ranked as sufficient, incomplete and poor by green, yellow and red, respectively.

\textbf{Turn this into chevrons?}
\end{quote}

% \begin{longtable}[c]{@{}llll@{}}
% \toprule
% & \textbf{Risk minimisation} & \textbf{Risk measurement} & \textbf{Risk management}\tabularnewline
% \midrule
% \endhead
% & \textbf{Mitigate avoidable risks} & \textbf{Reduce estimation error} & \textbf{Measure remaining risk}\tabularnewline
% \textbf{C'wlth} &\tabularnewline
% \textbf{NSW} &\tabularnewline
% \textbf{VIC} &\tabularnewline
% \textbf{QLD} &\tabularnewline
% \textbf{WA} &\tabularnewline
% \textbf{SA} &\tabularnewline
% \bottomrule
% \end{longtable}

\emph{\\[2\baselineskip]Sources: The XX publically available guidelines of the institutions listed in \_\_\_\_ as of October 2016, Grattan analysis.}
